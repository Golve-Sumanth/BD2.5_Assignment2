...
function sortByPriceAscending(stock1, stock2) {
  return stock1.price - stock2.price;
}

function sortByPriceDescending(stock1, stock2) {
  return stock2.price - stock1.price;
}

function sortByGrowthAscending(stock1, stock2) {
  return stock1.growth - stock2.growth;
}

function sortByGrowthDescending(stock1, stock2) {
...
app.get('/stocks/sort/pricing', (req, res) => {
  ...
  if (pricing === 'low-to-high') {
    sortedStocks.sort(sortByPriceAscending);
  } else {
    sortedStocks.sort(sortByPriceDescending);
  }
...
app.get('/stocks/sort/growth', (req, res) => {
  ...
  if (growth === 'high-to-low') {
    sortedStocks.sort(sortByGrowthDescending);
  } else {
    sortedStocks.sort(sortByGrowthAscending);
  }
  res.json({ stocks: sortedStocks });
});
